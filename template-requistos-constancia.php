    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-[#263b80] to-[#264da0] rounded-2xl overflow-hidden shadow-xl">
                <div class="lg:flex">
                    <div class="lg:w-1/2">
                        <img src="/wp-content/uploads/2026/03/RequisitosdeConstanciadeNoRequerirLicenciaAmbiental_Actualizada.jpg" alt="Noticia Destacada" class="w-full h-64 lg:h-full object-cover">
                    </div>
                    <div class="lg:w-1/2 p-8 lg:p-12 text-white">
                        ...
                        <a href="/wp-content/uploads/2026/03/RequisitosdeConstanciadeNoRequerirLicenciaAmbiental_Actualizada.jpg" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-6 py-3 bg-white text-[#231f20] font-semibold rounded-full hover:bg-[#ad8411] hover:text-white transition-colors duration-300">
                            Descargar Recurso
