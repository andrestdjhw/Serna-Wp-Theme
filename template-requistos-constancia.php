            ...
            <div class="bg-gradient-to-r from-[#263b80] to-[#264da0] rounded-2xl overflow-hidden shadow-xl">
                <div class="lg:flex">
                    ...
                    <div class="lg:w-1/2 p-8 lg:p-12 text-white">
                        ...
                        <a href="/wp-content/uploads/2025/08/Requisitos-de-Constancia-de-No-Requerir-Licencia-Ambiental.pdf" target="_blank" rel="noopener noreferrer" class="inline-flex items-center px-6 py-3 bg-white text-[#231f20] font-semibold rounded-full hover:bg-[#ad8411] hover:text-white transition-colors duration-300">
                            Descargar Recurso
