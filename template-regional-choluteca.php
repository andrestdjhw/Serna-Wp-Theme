<?php
/**
 * Template Name: Regional Choluteca Template
 * Template Post Type: page
 */

get_header(); ?>

<div class="regional-choluteca-page">
    <!-- hero section  -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-r from-[#00903b] to-[#7dbb5c] rounded-2xl p-8 md:p-12 text-white">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    <!-- Stat 1 -->
                    <div class="p-4">
                        <div class="text-4xl font-bold mb-2">49,579</div>
                        <div class="text-lg">Huevos de tortuga golfina recolectados</div>
                    </div>
                    
                    <!-- Stat 2 -->
                    <div class="p-4">
                        <div class="text-4xl font-bold mb-2">5,000+</div>
                        <div class="text-lg">Plantas de Arboles Producidas</div>
                    </div>
                    
                    <!-- Stat 3 -->
                    <div class="p-4">
                        <div class="text-4xl font-bold mb-2">6,000</div>
                        <div class="text-lg">Toneladas de reciduos recolectados</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="enhanced-gallery-grid">
                ...
                <div class="gallery-item featured">
                    <div class="gallery-wrapper">
                        <div class="image-container">
                            <img src="/wp-content/uploads/2025/06/Choluteca1.jpeg" alt="Actividad Principal Regional Ocotepeque" class="gallery-image">
                ...
                <div class="gallery-item medium">
                    <div class="gallery-wrapper">
                        <div class="image-container">
                            <img src="/wp-content/uploads/2025/06/Choluteca2.jpeg" alt="Capacitación Técnicos UMA" class="gallery-image">
                            <div class="image-overlay">
                                <div class="overlay-content">
                                    <div class="overlay-icon">
                ...
                <div class="gallery-item medium">
                    <div class="gallery-wrapper">
                        <div class="image-container">
                            <img src="/wp-content/uploads/2025/06/Choluteca3.jpeg" alt="Campañas de Limpieza" class="gallery-image">
                            <div class="image-overlay">
                                <div class="overlay-content">
                                    <div class="overlay-icon">
                                        <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="gallery-item small">
                    <div class="gallery-wrapper">
                        <div class="image-container">
                            <img src="/wp-content/uploads/2025/06/Choluteca4.jpeg" alt="Gestión de Residuos" class="gallery-image">
                            <div class="image-overlay">
                                <div class="overlay-content">
                                    <div class="overlay-icon">
                ...
                <div class="gallery-item small">
                    <div class="gallery-wrapper">
                        <div class="image-container">
                            <img src="/wp-content/uploads/2025/06/Choluteca5.jpeg" alt="Protección Forestal" class="gallery-image">
                            <div class="image-overlay">
                                <div class="overlay-content">
                                    <div class="overlay-icon">
                                        <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
