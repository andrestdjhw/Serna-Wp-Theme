        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-r from-[#263b80] to-[#264da0] rounded-2xl p-8 md:p-12 text-white">
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 text-center">
                    <!-- Stat 1 -->
                    <div class="p-4">
                        <div class="text-4xl font-bold mb-2 text-[#e3a220] mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-[#ad8411] to-[#FFFFFF] animate-gradient">Protegiendo la Biodiversidad y Recuperando Ecosistemas Degradados</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="space-y-12">
                    ...
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#264da0] mb-2">Corredores biológicos definidos a nivel estructural.</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#264da0] mb-2">Plan de restauración que incluye a la biodiversidad.</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#264da0] mb-2">13 viveros identificados para su restauración con al menos dos manejados por mujeres.</h3>
                            </div>
                        </div>
                    </div>
                    <!-- Timeline Item 4 -->
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#264da0] mb-2">14 fincas pilotos identificadas para el cambio de producción tradicional a producción sostenible (orgánica).</h3>
                            </div>
                        </div>
                    </div>
                </div>
