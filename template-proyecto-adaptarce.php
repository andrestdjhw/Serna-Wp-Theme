<?php
/**
 * Template Name: Proyecto Adaptarce+ Template
 * Template Post Type: page
 */

get_header(); ?>

<div class="proyecto-adaptarce-page">
    <!-- hero section  -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-r from-[#00903b] to-[#7dbb5c] rounded-2xl p-8 md:p-12 text-white">
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 text-center">
                    <!-- Stat 1 -->
                    <div class="p-4">
                        <div class="text-4xl font-bold mb-2">Adaptación Basado en Ecosistemas del Corredor Boscoso Central </div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                ...
                                <p class="text-gray-600">
                                    Los técnicos de campo han trabajado efectivamente con grupos conformados por mujeres, llevando a cabo actividades como parcelas demostrativas para diversificar los medios de vida agrícola, la instalación de eco hornos y panaderías como parte de las estrategias de diversificación de las formas de vida. Además, se han implementado bio-fábricas para la elaboración de abonos orgánicos, acciones de reforestación y contribuciones al ámbito agroforestal mediante la adquisición de árboles frutales y forestales. Se proporciona apoyo a través de la dotación de kits de sistema de riego por goteo con almacenamiento en geomembrana, herramientas y semillas. Como parte de la sensibilización y participación equitativa, se ha llevado a cabo una campaña de sensibilización sobre la importancia de lograr la participación equitativa de mujeres y hombres en todos los aspectos de la comunidad, incluyendo la toma de decisiones y proyectos ambientales, lo anterior con la colaboración de las 14 Oficinas Municipales de la Mujer (OMM) y Ciudad Mujer, permitiendo la realización de capacitaciones que abordan los estereotipos de género, expectativas culturales que podrían limitar la participación de mujeres y jóvenes en roles de liderazgo y toma de decisiones, así como el reconocimiento de las desigualdades y la violencia machista y patriarcal experimentada en sus territorios.
                                </p>
                            </div>
                        </div>
                    </div>
