            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="lg:w-1/2">
                    <div class="bg-gradient-to-r from-[#00903b] to-[#7dbb5c] rounded-2xl overflow-hidden shadow-xl transform rotate-1 hover:rotate-0 transition-transform duration-300">
                        <img src="/wp-content/uploads/2025/08/RAEEbanner.jpeg" alt="Banner RAEE" class="w-full h-auto object-cover opacity-90 hover:opacity-100 transition-opacity duration-300">
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="grid md:grid-cols-2 gap-8">
                                    ...
                                    <div class="space-y-6">                       
                                        ...
                                        <div class="flex items-start space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-white">Edificio CESCCO-SERNA Barrio Morazán, Frente a Central de Bomberos Tegucigalpa M.D.C., Francisco Morazán</p>
                                    ...
                                    <div class="bg-gradient-to-r from-[#87cede] to-blue-300  rounded-lg p-4 backdrop-blur-sm">
                                        ...
                                        <div class="bg-white rounded-lg overflow-hidden shadow-md">
                                            ...
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d61914.069203596344!2d-87.27554082870482!3d14.099045593217774!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f6fa2b8f7e0c237%3A0x16dada0c6de8ec57!2s3QXW%2B9CM%2C%20Tegucigalpa%2C%20Francisco%20Moraz%C3%A1n!5e0!3m2!1ses!2shn!4v1756236902331!5m2!1ses!2shn" width="600" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative">
                    ...
                    <div class="carousel-track flex transition-transform duration-500 ease-in-out" id="carouselTrack">
                        ...
                        <div class="carousel-slide w-full flex-shrink-0 relative">
                            <div class="bg-gradient-to-r from-[#7dbb5c] to-[#87cede] h-96 md:h-[500px] flex items-center justify-center relative overflow-hidden">
                                ...
                                <img src="/wp-content/uploads/2025/08/RAEE1.jpeg" alt="Actividad 1 RAEE" class="absolute inset-0 w-full h-full object-cover opacity-80" >
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide w-full flex-shrink-0 relative">
                            <div class="bg-gradient-to-r from-[#7dbb5c] to-[#87cede] h-96 md:h-[500px] flex items-center justify-center relative overflow-hidden">
                                ...
                                <!-- Placeholder for actual image -->
                                <img src="/wp-content/uploads/2025/08/RAEE2.jpeg" alt="Actividad 2 RAEE" class="absolute inset-0 w-full h-full object-cover opacity-80" >
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide w-full flex-shrink-0 relative">
                            <div class="bg-gradient-to-r from-[#7dbb5c] to-[#87cede] h-96 md:h-[500px] flex items-center justify-center relative overflow-hidden">
                                ...
                                <!-- Placeholder for actual image -->
                                <img src="/wp-content/uploads/2025/08/RAEE3.jpeg" alt="Actividad 3 RAEE" class="absolute inset-0 w-full h-full object-cover opacity-80" >
                            </div>
                        </div>
                        ...
                        <div class="carousel-slide w-full flex-shrink-0 relative">
                            <div class="bg-gradient-to-r from-[#7dbb5c] to-[#87cede] h-96 md:h-[500px] flex items-center justify-center relative overflow-hidden">
                                ...
                                <!-- Placeholder for actual image-->
                                <img src="/wp-content/uploads/2025/08/RAEE4.jpeg" alt="Actividad 4 RAEE" class="absolute inset-0 w-full h-full object-cover opacity-80" >
                            </div>
                        </div>
                        <!-- Slide 5 -->
                        <div class="carousel-slide w-full flex-shrink-0 relative">
                            <div class="bg-gradient-to-r from-[#7dbb5c] to-[#87cede] h-96 md:h-[500px] flex items-center justify-center relative overflow-hidden">
                                ...
                                <!-- Placeholder for actual image-->
                                <img src="/wp-content/uploads/2025/08/RAEE5.jpeg" alt="Actividad 4 RAEE" class="absolute inset-0 w-full h-full object-cover opacity-80" >
                            </div>
                        </div>
                        <!-- Slide 6 -->
                        <div class="carousel-slide w-full flex-shrink-0 relative">
                            <div class="bg-gradient-to-r from-[#7dbb5c] to-[#87cede] h-96 md:h-[500px] flex items-center justify-center relative overflow-hidden">
                                ...
                                <!-- Placeholder for actual image-->
                                <img src="/wp-content/uploads/2025/08/RAEE6.jpeg" alt="Actividad 4 RAEE" class="absolute inset-0 w-full h-full object-cover opacity-80" >
                            </div>
                        </div>
                        <!-- Slide 7 -->
                        <div class="carousel-slide w-full flex-shrink-0 relative">
                            <div class="bg-gradient-to-r from-[#7dbb5c] to-[#87cede] h-96 md:h-[500px] flex items-center justify-center relative overflow-hidden">
                                ...
                                <!-- Placeholder for actual image-->
                                <img src="/wp-content/uploads/2025/08/RAEE7.jpeg" alt="Actividad 4 RAEE" class="absolute inset-0 w-full h-full object-cover opacity-80" >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex justify-center mt-8 space-x-3">
                    ...
                    <button class="carousel-dot w-3 h-3 rounded-full bg-gray-300 hover:bg-[#5ca54c] transition-all duration-300" onclick="goToSlide(4)"></button>
                    ...
                    <button class="carousel-dot w-3 h-3 rounded-full bg-gray-300 hover:bg-[#5ca54c] transition-all duration-300" onclick="goToSlide(6)"></button>
                </div>
            </div>
        </div>
    </section>
