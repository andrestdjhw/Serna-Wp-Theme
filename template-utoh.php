...
<div class="utoh-page">
                ...
                <div class="space-y-12">
                    ...
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#00903b] mb-2">¿Qué es una SAO?</h3>
                    ...
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#5ca54c] mb-2">¿Por qué es importante la capa de ozono?</h3>
                                <p class="text-gray-600">
                                    ...
                                    <ul class="list-disc mt-3">
                                        <li class="text-sm text-[#5ca54c] mb-3">Aumenta el riesgo de cáncer de piel y cataratas.</li>
                                        <li class="text-sm text-[#5ca54c] mb-3">Se debilita el sistema inmunológico.</li>
                                        <li class="text-sm text-[#5ca54c] mb-3">Afecta cultivos, ecosistemas marinos y animales.</li>
                                    </ul>    
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#7dbb5c] mb-2">¿Por qué debemos eliminar las SAO?</h3>
                                <p class="text-gray-600">
                    ...
                    <div class="relative pl-20 md:pl-24">
                        ...
                        <div class="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-transform hover:translate-y-[-5px]">
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#00903b] mb-2">¿Qué hacemos?</h3>
                                <p class="text-gray-600">
                                    <ul class="list-disc">
    ...
    <div class="max-w-4xl mx-auto mt-16 mb-16 bg-gradient-to-r from-[#00903b] to-[#7dbb5c] rounded-2xl p-8 md:p-12 text-white text-center">
        ...
        <p class="text-xl text-green-900 mb-8">Es una fuente oficial, transparente y pública que permite <strong>monitorear el progreso nacional en la protección de la capa de ozono y el clima,</strong> y es de gran utilidad para técnicos, tomadores de decisión, académicos y organismos de cooperación.</p>
        <a 
    ...
    <section class="bg-white rounded-lg shadow-custom p-8 md:p-12 text-center">
        <h2 class="text-3xl font-bold text-[#00903b] mb-6"><span class="bg-clip-text text-transparent bg-gradient-to-r from-[#00903b] to-[#7dbb5c]">Trámites en línea</span></h2>
