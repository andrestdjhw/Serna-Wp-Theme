<?php
/**
 * Template Name: Proyecto Conecta+ Template
 * Template Post Type: page
 */

get_header(); ?>

<div class="proyecto-conecta-page">
    <!-- hero section  -->
            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="lg:w-1/2">
                    <div class="bg-gradient-to-r from-[#00903b] to-[#7dbb5c] rounded-2xl overflow-hidden shadow-xl transform rotate-1 hover:rotate-0 transition-transform duration-300">
                        <img src="/wp-content/uploads/2025/06/BannerConectaMas.jpg" alt="Banner del Proyecto Conecta+" class="w-full h-auto object-cover opacity-90 hover:opacity-100 transition-opacity duration-300">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#7dbb5c] mb-2">Elaboración de estudios e informes técnicos:
                                    <ul class="list-disc">
                                        ...
                                        <li>Análisis de avance de la frontera agrícola (2018-2020) en 14 Áreas protegidas de Honduras.</li>
                                    </ul>
                                </h3>
                            </div>
                        </div>
                            ...
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-[#00903b] mb-2">Fortalecimiento de la gobernanza y conservación con el desarrollo y apoyo de eventos::
                                    <ul class="list-disc">
                                        ...
                                        <li>Celebración del Día de las Áreas Protegidas de Latinoamérica y el Caribe Foro Regional de las Organizaciones de Pueblos Indígenas de la UICN (OPIs) y el Consejo Indígena de Centroamérica (CICA) sobre “Pueblos Indígenas, Áreas Protegidas y Otras Medidas Efectivas de Conservación (OMEC)”.</li>
                                    </ul>
                                </h3>
                            </div>
                        </div>
